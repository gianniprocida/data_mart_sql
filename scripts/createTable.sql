...
create table if not exists Listings (id int not null, user_id int not null,title varchar(200),property_type varchar(100),
...
create table if not exists Payments (id int not null,payment_method varchar(100),payment_date date,amount decimal(12,4));

create table if not exists Reservations (id int not null,guest_id int not null,listing_id int not null, check_in_date date,check_out_date date,total_cost decimal(8,4), INDEX(id));

create table if not exists ListingsAmenities (id int not null,listing_id int not null,amenity_id int not null);

create table if not exists PaymentsReservations (id int not null,reservation_id int not null,payment_id int not null);
